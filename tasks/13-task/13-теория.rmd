...
Адрес сети:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; \textcolor{blue}{10101100.00100101.1100}0000.00000000 -> 172.37.192.0


Номер компьютера: 00000000000000000000\textcolor{red}{100100001101} -> 2317
...
\center где $\&$ - поразрядная конъюнкция. \center

\newpage
\section{Решения на Python}
\subsection{Введение}
...
- `ipaddress.ip_network(address, strict=True)` - функция, которая поможет работать с адресом сети.
...
\newpage
\subsection{Решаем задачки}
\subsubsection{Задачка на поиск третьего слева байта маски}
\center ![](../../data/13-images/10150-kompege.png) \center
...
\newpage
\subsubsection{Задачка на поиск наименьшего третьего слева байта маски}
\center ![](../../data/13-images/11769-kompege.png) \center
...
\newpage
\subsubsection{Задачка на поиск наибольшего кол-ва единиц в двоичной записи маски}
\center ![](../../data/13-images/11765-kompege.png) \center
...
\newpage
\subsubsection{Задачка на поиск возможных вариантов маски для двух IP-адресов в одной сети}
\center ![](../../data/13-images/10788-kompege.png) \center
...
\newpage
\subsubsection{Задачка на определение кол-ва адресов компьютеров}
\center ![](../../data/13-images/10576-kompege.png) \center
...
\newpage
\subsubsection{Определяем кол-во масок при минимальном кол-ве узлов}
\center ![](../../data/13-images/10581-kompege.png) \center
...
\newpage
\subsubsection{Определяем кол-во IP-адресов в сети с доп. условием}
\center ![](../../data/13-images/162-polyakov.png) \center
...
\newpage
\subsubsection{Определяем номер компьютера в сети}
\center ![](../../data/13-images/10775-kompege.png) \center

- Будет проходиться по всем IP-адресам в адресе сети, пока не встретим нужный IP-адрес.
...
- Метод `hosts()` выдает IP-адреса в адресе сети, исключая сетевые и широковещательные.

\newpage
\subsubsection{Определяем кол-во IP-адресов, для которых числовое значение четырехбайтного IP-адреса кратно четырем}
\center ![](../../data/13-images/165-polyakov.png) \center
